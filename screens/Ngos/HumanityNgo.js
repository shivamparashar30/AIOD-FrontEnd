            ...
            <View style={styles.container}>
                <View style={styles.topContainer}>
                    ...
                    <View style={styles.titleTextContainer}>
                        <Text style={styles.titleText(COLORS.primary, SIZES.xSmall - 5)}>Humanity United Org.. </Text>
                    </View>
                </View>
            </View>
            ...
            >
                ...
                <View style={styles.ngoImgContainer}>
                    <Image style={styles.ngoImg}
                        source={require('../../assets/images/ngo5.jpeg')}
                    />
                </View>
                <View >
                ...
                <View>
                    <Text style={{
                        ...
                        Humanity United Charity is a non-profit orphanage home that has been providing care for orphaned and vulnerable children since 1998. Our organization was founded with the belief that every child deserves a safe and loving home, and we have been committed to this mission for over two decades.
                    </Text>
                    <Text style={{
                        fontSize: 14,
                        fontWeight: '400',
                        ...
                        At Humanity United Charity, we provide food, shelter, education, and medical care to children who have been orphaned, abandoned, or abused.
                    </Text>
                    {/* <Text style={{
                        fontSize: 14,
                        fontWeight: '400',
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View>
                            <Text style={{
                                ...
                                marginHorizontal: 0,
                                textAlign: 'justify'
                            }}> help.Humanity Unitedcharity.com</Text>
                        </View>
                    </View>
