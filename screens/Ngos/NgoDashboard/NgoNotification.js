...
import NgoMoneyNotification from "./NgoMoneyNotification";
import NgoOtherNotification from "./NgoOtherNotification";
import { COLORS } from "../../../constants";
...
const NgoNotification = () => {
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            >
                <Tab.Screen name="Money" component={NgoMoneyNotification} />
                <Tab.Screen name="Others" component={NgoOtherNotification} />
            </Tab.Navigator>
        </SafeAreaView>
