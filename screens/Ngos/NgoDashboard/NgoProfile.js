...
//         }).then((apiResponse) => {
//             setIsLoading(false)
//             const { username, name, email, phoneno, ImageUrl, Description, Address, driverName, driverPhone } = apiResponse.data.data;
...
//                         {/* Driver Name */}
//                         <View>
//                             <Text className="text-gray-700 ml-7 font-bold ">Driver Name</Text>
//                             <TextInput
//                                 value={driverName}
...
//                         {/* Driver Phone */}
//                         <View>
//                             <Text className="text-gray-700 ml-7 font-bold ">Driver Phone Number</Text>
//                             <TextInput
//                                 value={driverPhone}
//                                 onChangeText={setDriverPhone}
//                                 className="p-4 bg-gray-200 text-gray-700 rounded-2xl mb-4, mx-4"
//                                 style={{ padding: 30, marginTop: 10 }}
//                                 placeholder='Add Driver Phone no'
//                             />
//                             <TouchableOpacity>
//                                 <Ionicons name="create-outline" size={20} marginTop={-42} marginLeft={339} style={styles.icons} />
//                             </TouchableOpacity>
            ...
            <View style={{ width: '100%', height: '100%' }}>
                ...
                <ScrollView>
                    <View>
                        <View style={{ padding: 20, alignItems: 'center' }}>
                            <Image
                                ...
                                source={require('../../../assets/images/shivam.jpeg')}
                            />
                            <TouchableOpacity>
                                <View
                                    style={{
                    ...
                    <View className="form space-y-2">
                        ...
                        {/* Driver Phone */}
                        <View>
                            <Text className="text-gray-700 ml-7 font-bold ">
                                Driver Phone Number
                            </Text>
                            <TextInput
                                value={driverPhone}
                    ...
                    <TouchableOpacity onPress={logout}>
                        <View>
                            <Text style={{ textAlign: 'center', color: 'red', marginTop: 25 }}>
                                Logout
                            </Text>
                        </View>
                    </TouchableOpacity>
