...
const AddAddressDetailsBooks = () => {
    ...
    const [address1, setAddress1] = useState('PES University')
    const [address2, setAddress2] = useState('Pes University, Dwaraka Nagar, BSK 3rd Stage')
    const [address3, setAddress3] = useState('Bangalore, Karnataka, India')
    const [pincode, setPincode] = useState('560085')
    const [phoneno, setPhoneno] = useState('8112270790')
    ...
    return (
        <SafeAreaView>
            ...
            {/* TextInput Fields */}
            <TextInput style={styles.textInputt} value={address1} onChangeText={setAddress1}
            />
            <TextInput style={styles.textInputt} value={address2} onChangeText={setAddress2}
            />
            <TextInput style={styles.textInputt} value={address3} onChangeText={setAddress3} />
            <TextInput style={styles.textInputt} value={pincode} onChangeText={setPincode} />
            <TextInput style={styles.textInputt} value={phoneno} onChangeText={setPhoneno} />
